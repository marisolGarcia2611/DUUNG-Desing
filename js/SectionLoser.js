const sectionLoser = document.querySelector('#sectionLoser');

sectionLoser.innerHTML = `
<div class="context">
    <main class="bloquePrincipal">
      <div class="position-relative">
       <h1 class="position-absolute title__p1 start-50 translate-middle-x">Partida Terminada</h1>
        <img class="position-absolute  start-50 translate-middle-x img__central" src="Images/Loser.png"/>
